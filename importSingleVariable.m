function [Word,Score] = importSingleVariable(filename, startRow, endRow)
%IMPORTFILE Import numeric data from a text file as column vectors.
%   [WORD,SCORE] = IMPORTFILE(FILENAME) Reads data from text file FILENAME
%   for the default selection.
%
%   [WORD,SCORE] = IMPORTFILE(FILENAME, STARTROW, ENDROW) Reads data from
%   rows STARTROW through ENDROW of text file FILENAME.
%
% Example:
%   [Word,Score] = importfile('AFINN-111-preprocessed.csv',2, 2463);
%
%    See also TEXTSCAN.

% Auto-generated by MATLAB on 2016/12/06 12:54:49
